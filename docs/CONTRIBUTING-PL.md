# Współtworzenie BlockStarDesk

BlockStarDesk z zadowoleniem przyjmuje wkład od każdego. Oto wytyczne, jeśli chcesz nam pomóc:

## Współtwórcy

Contributions to BlockStarDesk or its dependencies should be made in the form of GitHub
...
BlockStarDesk contributors frequent the [Discord](https://discord.gg/nDceKgxnkV).
