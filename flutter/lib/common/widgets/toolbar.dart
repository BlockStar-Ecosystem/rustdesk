...
bool showVirtualDisplayMenu(FFI ffi) {
  ...
  if (ffi.ffiModel.pi.isBlockStarDeskIdd || ffi.ffiModel.pi.isAmyuniIdd) {
    return true;
  }
  return false;
}
...
List<Widget> getVirtualDisplayMenuChildren(
  ...
  if (pi.isBlockStarDeskIdd) {
    final virtualDisplays = ffi.ffiModel.pi.BlockStarDeskVirtualDisplays;
