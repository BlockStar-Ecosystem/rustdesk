...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsBlockStarDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsBlockStarDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsBlockStarDeskVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get BlockStarDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsBlockStarDeskVirtualDisplays] ?? []);
