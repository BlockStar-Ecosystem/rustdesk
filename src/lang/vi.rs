...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới BlockStar Desktop..."),
        ...
        ("install_tip", "Do cơ chế UAC, BlockStar Desktop có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt BlockStar Desktop vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho BlockStar Desktop."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho BlockStar Desktop."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [BlockStar Desktop Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep BlockStar Desktop background service", "Giữ dịch vụ BlockStar Desktop chạy nền"),
        ...
        ("Show BlockStar Desktop", "Hiện BlockStar Desktop"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu BlockStar Desktop"),
        ...
        ("scam_text2", "Chỉ sử dụng BlockStar Desktop với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ BlockStar Desktop mở"),
        ...
        ("floating_window_tip", "Giữ BlockStar Desktop trên cùng"),
        ...
        ("About BlockStar Desktop", "Về BlockStar Desktop"),
