...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới BlockStarDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, BlockStarDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt BlockStarDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho BlockStarDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho BlockStarDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [BlockStarDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep BlockStarDesk background service", "Giữ dịch vụ BlockStarDesk chạy nền"),
        ...
        ("Show BlockStarDesk", "Hiện BlockStarDesk"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu BlockStarDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng BlockStarDesk với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ BlockStarDesk mở"),
        ...
        ("floating_window_tip", "Giữ BlockStarDesk trên cùng"),
        ...
        ("About BlockStarDesk", "Về BlockStarDesk"),
