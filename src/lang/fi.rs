...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään BlockStarDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa BlockStarDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi RustDeskin järjestelmään."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten BlockStarDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli BlockStarDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "BlockStarDesk palvelu käynnistyy taustalla."),
        ...
        ("android_start_service_tip", "BlockStarDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep BlockStarDesk background service", "Pidä RustDeskin taustapalvelu käynnissä"),
        ...
        ("Show BlockStarDesk", "Näytä BlockStarDesk"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista BlockStarDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "BlockStarDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä BlockStarDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-BlockStarDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
