...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään BlockStar Desktop verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa BlockStar Desktop ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi RustDeskin järjestelmään."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten BlockStar Desktop daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli BlockStar Desktop ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "BlockStar Desktop palvelu käynnistyy taustalla."),
        ...
        ("android_start_service_tip", "BlockStar Desktop palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep BlockStar Desktop background service", "Pidä RustDeskin taustapalvelu käynnissä"),
        ...
        ("Show BlockStar Desktop", "Näytä BlockStar Desktop"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista BlockStar Desktop salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "BlockStar Desktop ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä BlockStar Desktop Server Pro versioon {} jatkaaksesi."),
        ...
        ("About BlockStar Desktop", "Tietoa RustDeskistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-BlockStar Desktop-asiakasversioon {} yhteensopivuuden takaamiseksi"),
