...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the BlockStar Desktop network..."),
        ...
        ("install_tip", "Due to UAC, BlockStar Desktop can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install BlockStar Desktop to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant BlockStar Desktop \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant BlockStar Desktop \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow BlockStar Desktop to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [BlockStar Desktop Input] service."),
        ...
        ("doc_mac_permission", "https://blockstar.site/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next BlockStar Desktop application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant BlockStar Desktop \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant BlockStar Desktop \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running BlockStar Desktop."),
        ...
        ("verify_rustdesk_password_tip", "Verify BlockStar Desktop password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use BlockStar Desktop and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade BlockStar Desktop Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://blockstar.site/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent BlockStar Desktop from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by BlockStar Desktop"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if BlockStar Desktop window is open"),
        ...
        ("floating_window_tip", "It helps to keep BlockStar Desktop background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the BlockStar Desktop client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, BlockStar Desktop verifies the server certificate for protocols using TLS.\nWith this option enabled, BlockStar Desktop will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, BlockStar Desktop will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: BlockStar Desktop server OSS doesn't include this feature."),
