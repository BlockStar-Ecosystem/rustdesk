...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem BlockStar Desktop..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, BlockStar Desktop v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ...
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »BlockStar Desktop Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep BlockStar Desktop background service", "Ohrani RustDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije BlockStar Desktop, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "BlockStar Desktop potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "BlockStar Desktop potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za BlockStar Desktop"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite BlockStar Desktop, prekinite klic in program zaprite."),
        ("scam_text2", "BlockStar Desktop omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite BlockStar Desktop Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo BlockStar Desktop"),
        ...
        ("floating_window_tip", "Pomaga pri BlockStar Desktop storitvi v ozadju"),
        ...
        ("About BlockStar Desktop", "O RustDesku"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite BlockStar Desktop odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
