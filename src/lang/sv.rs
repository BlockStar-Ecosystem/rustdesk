...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till BlockStar Desktop..."),
        ...
        ("install_tip", "På grund av UAC, kan inte BlockStar Desktop fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera BlockStar Desktop på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge BlockStar Desktop \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge BlockStar Desktop \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [BlockStar Desktop Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep BlockStar Desktop background service", "Behåll BlockStar Desktop i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa BlockStar Desktop programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show BlockStar Desktop", "Visa BlockStar Desktop"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
