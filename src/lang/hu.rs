...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a BlockStarDesk alkalmazást a számítógépére."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a BlockStarDesk számára a \"Hozzáférhetőség\" szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [BlockStarDesk Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep BlockStarDesk background service", "BlockStarDesk futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a BlockStarDesk alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show BlockStarDesk", "A BlockStarDesk megjelenítése"),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az \"Igen\" gombra kell kattintania a BlockStarDesk UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "BlockStarDesk jelszó megerősítése"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Frissítse a BlockStarDesk Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a BlockStarDesk nem fut megfelelően, mint ellenőrzött."),
        ...
        ("powered_by_me", "Üzemeltető: BlockStarDesk"),
        ("outgoing_only_desk_tip", "Ez a BlockStarDesk testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a BlockStarDesk ablaka nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a BlockStarDesk a háttérben fut."),
        ...
        ("About BlockStarDesk", "A BlockStarDesk névjegye"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Frissítse a BlockStarDesk klienst {} vagy újabb verziójára a távoli oldalon!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Alapértelmezés szerint a BlockStarDesk ellenőrzi a kiszolgáló tanúsítványát a TLS-protokollok esetében. Ha ez a beállítás engedélyezve van, a BlockStarDesk kihagyja az ellenőrzési lépést, és az ellenőrzés sikertelensége esetén folytatja a műveletet."),
        ("Disable UDP", "UDP letiltása"),
        ("disable-udp-tip", "Meghatározza, hogy csak TCP-t használjon-e. Ha ez az beállítás engedélyezve van, a BlockStarDesk nem fogja többé használni a 21116-os UDP-portot, helyette a 21116-os TCP-portot fogja használni."),
        ("server-oss-not-support-tip", "MEGJEGYZÉS: Az OSS BlockStarDesk kiszolgáló nem támogatja ezt a funkciót."),
