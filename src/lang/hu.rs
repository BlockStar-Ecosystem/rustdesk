...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a BlockStar Desktop alkalmazást a számítógépére."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a BlockStar Desktop számára a \"Hozzáférhetőség\" szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [BlockStar Desktop Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep BlockStar Desktop background service", "BlockStar Desktop futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a BlockStar Desktop alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show BlockStar Desktop", "A BlockStar Desktop megjelenítése"),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az \"Igen\" gombra kell kattintania a BlockStar Desktop UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "BlockStar Desktop jelszó megerősítése"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Frissítse a BlockStar Desktop Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a BlockStar Desktop nem fut megfelelően, mint ellenőrzött."),
        ...
        ("powered_by_me", "Üzemeltető: BlockStar Desktop"),
        ("outgoing_only_desk_tip", "Ez a BlockStar Desktop testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a BlockStar Desktop ablaka nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a BlockStar Desktop a háttérben fut."),
        ...
        ("About BlockStar Desktop", "A BlockStar Desktop névjegye"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Frissítse a BlockStar Desktop klienst {} vagy újabb verziójára a távoli oldalon!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Alapértelmezés szerint a BlockStar Desktop ellenőrzi a kiszolgáló tanúsítványát a TLS-protokollok esetében. Ha ez a beállítás engedélyezve van, a BlockStar Desktop kihagyja az ellenőrzési lépést, és az ellenőrzés sikertelensége esetén folytatja a műveletet."),
        ("Disable UDP", "UDP letiltása"),
        ("disable-udp-tip", "Meghatározza, hogy csak TCP-t használjon-e. Ha ez az beállítás engedélyezve van, a BlockStar Desktop nem fogja többé használni a 21116-os UDP-portot, helyette a 21116-os TCP-portot fogja használni."),
        ("server-oss-not-support-tip", "MEGJEGYZÉS: Az OSS BlockStar Desktop kiszolgáló nem támogatja ezt a funkciót."),
