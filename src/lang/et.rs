...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa BlockStarDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et BlockStarDesk oma süsteemi paigaldada."),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [BlockStarDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep BlockStarDesk background service", "Säilita RustDeski taustateenus"),
        ...
        ("Show BlockStarDesk", "Kuva BlockStarDesk"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda BlockStarDesk Server Pro versioonile {} või uuem!"),
        ...
        ("About BlockStarDesk", "RustDeski teave"),
