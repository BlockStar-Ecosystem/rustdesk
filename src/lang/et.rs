...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa BlockStar Desktop mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et BlockStar Desktop oma süsteemi paigaldada."),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [BlockStar Desktop Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep BlockStar Desktop background service", "Säilita RustDeski taustateenus"),
        ...
        ("Show BlockStar Desktop", "Kuva BlockStar Desktop"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda BlockStar Desktop Server Pro versioonile {} või uuem!"),
        ...
        ("About BlockStar Desktop", "RustDeski teave"),
