...
pub mod amyuni_idd {
    ...
    // 2. BlockStar Desktop may crash and restart, but the virtual displays are kept.
    //
    ...
    //             if there're no virtual displays managed by BlockStar Desktop.
    pub fn plug_out_monitor(index: i32, force_all: bool, force_one: bool) -> ResultType<()> {
        ...
        //
        // 1. BlockStar Desktop plug in 2 virtual displays. (BlockStar Desktop)
        // 2. Other process plug out all virtual displays. (User manually)
        // 3. Other process plug in 1 virtual display. (User manually)
        // 4. BlockStar Desktop plug out all virtual displays in this call. (BlockStar Desktop disconnect)
        //
        // This is not a normal scenario, BlockStar Desktop will plug out virtual display unexpectedly.
