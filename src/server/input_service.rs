...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // 1. Press "Command" key in BlockStar Desktop
            // 2. Move the physical mouse
            // 3. Press "V" key in BlockStar Desktop
            ...
            // we consider only BlockStar Desktop operates the controlled side.
            //
...
fn key_sleep() {
    ...
    // Though `/Applications/BlockStar Desktop.app/Contents/MacOS/rustdesk --server` in terminal is ok.
    let now = Instant::now();
